    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-24 flex items-center justify-between">
      <div class="grid lg:grid-cols-2 gap-10">
        <div>
          ...
          <p class="mt-4 text-base sm:text-lg text-slate-600 dark:text-slate-300">Jadwal asistensi, pelaporan perangkat, cepat, dan transparan</p>
          <div class="mt-6 flex flex-col sm:flex-row gap-3">
            <a href="#jadwal" class="inline-flex items-center justify-center rounded-xl bg-brand-600 px-6 py-3 text-white font-semibold shadow-soft hover:bg-brand-700">Lihat Jadwal Asisten</a>
            <a href="#perangkat" class="inline-flex items-center justify-center rounded-xl px-6 py-3 font-semibold border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800">Lihat Perangkat</a>
          </div>
          <div class="mt-8 grid grid-cols-3 gap-6 text-center">
            <div><div class="text-3xl font-extrabold">2</div><div class="mt-1 text-xs text-slate-500">Lab Hardware</div></div>
